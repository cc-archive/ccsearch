...
function doSearch() {
    ...
    if ((query.value.length > 0) && (query.className == "active")) {
        ...
        switch (engine) {
            ...
            case "blip":
                url = 'http://blip.tv/posts/view/?search=' + query.value + 
                      '&section=/posts/view&sort=popularity&' + rights;
                break;
                
            case "flickr":
                url = 'http://flickr.com/search/?' + 
                      ((rights.length > 2) ? rights : "l=cc") + '&q=' + 
                      query.value;
                break;
                
            case "yahoo":
                url = 'http://search.yahoo.com/search?cc=1&p=' + query.value + 
                      rights;
                if (lang_xml != "") 
            ...
            default:
                url = 'http://google.com/search' + 
                      ...
                      ((id('comm').checked) ? "" : "|cc_noncommercial") + 
                      ((id('deriv').checked) ? "" : "|cc_nonderived") + ')' + 
